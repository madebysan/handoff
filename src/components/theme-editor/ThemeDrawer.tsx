  ...
  return (
    <>
      ...
      <button
        ...
        className={`theme-editor-reset fixed bottom-4 left-4 z-[9998] w-11 h-11 flex items-center justify-center rounded-full shadow-lg transition-colors ${
          open
      ...
      <div
        ref={popoverRef}
        className={`theme-editor-reset fixed bottom-16 left-4 z-[9998] w-80 max-h-[65vh] bg-popover rounded-xl shadow-2xl border border-border flex flex-col transition-all duration-200 ease-out ${
          open
